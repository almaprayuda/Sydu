		...
		<div class="card shadow" style="width: 30em; margin: auto; padding: 20px; margin-top: 60px;">
			...
			<?php
				...
				elseif (isset($_GET['logout'])) {
					echo "<p class='text-center' style='color: limegreen; font-size: 15px;'>Sampai nanti!</p>";
				}
				elseif (isset($_GET['reject'])) {
					echo "<p class='text-center' style='color: red; font-size: 15px;'>Silahkan login terlebih dahulu!</p>";
				}
			?>
